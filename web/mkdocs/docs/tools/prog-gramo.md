# Tutoriel : Programmer le Gramophone
...
<a href="https://faustide.grame.fr/?mode=amstram&code=https://www.amstramgrame.fr/tools/prog-gramo/exfaust0/exfaust0.dsp" target="editor">
...
<a href="https://faustide.grame.fr/?mode=amstram&code=https://www.amstramgrame.fr/tools/prog-gramo/exfaust1/exfaust1.dsp" target="editor">
<button type="button" class="btn btn-primary">Éditer/exécuter le programme >></button></a>
</div>
<!-- /faust-run -->
