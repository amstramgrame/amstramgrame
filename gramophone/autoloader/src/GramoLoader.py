...
appRunningMessage = 'Programmation terminée,\nen attente d’un nouveau fichier.'
initialZipMessage = 'Veuillez sélectionner le binaire\nFaust que vous avez téléchargé ->'
...
changeFileB.place(anchor=NE, x=(995/2), y=(20/2))

status = Label(window, text = waitingMessage, font=("Helvetica", 16))
